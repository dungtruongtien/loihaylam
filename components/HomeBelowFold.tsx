        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2.5rem', alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{ fontWeight: 800, fontSize: '1.75rem', marginBottom: '1rem', lineHeight: 1.3 }}>{t('home.tod.title')}</h2>
              <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '1.25rem' }}>{t('home.tod.desc')}</p>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2.5rem', alignItems: 'center' }}>
            ...
            <div style={{ order: 2 }}>
              ...
              <h2 style={{ fontWeight: 800, fontSize: '1.75rem', marginBottom: '1rem', lineHeight: 1.3 }}>{t('home.ww.title')}</h2>
              <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '1.25rem' }}>{t('home.ww.desc')}</p>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1.5rem' }}>
                {wwFeatures.map((key) => (
                  <li key={key} style={{ color: 'var(--text-muted)', fontSize: '0.9rem', display: 'flex', gap: '0.5rem' }}>
